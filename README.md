This data labeling tool is a simple web app for labeling data in a CSV file. It is built with TypeScript and uses the PapaParse library for parsing CSV files.
